...
export function WhoWeWorkWith() {
  ...
  const clients = [
    { titleKey: 'clients_1_title', bodyKey: 'clients_1_body', image: '/businesses%20copy.jpeg' },
    { titleKey: 'clients_2_title', bodyKey: 'clients_2_body', image: '/families%20copy.jpeg' },
    ...
    <div className="bg-white">
      ...
      <div className="px-6 md:px-16 pt-0 pb-20 md:pb-28 -mt-4">
        <div className="max-w-[900px] mx-auto flex justify-center">
          <img src="/investors%20copy.jpeg" alt="" className="h-auto block max-w-[520px] w-full" />
        </div>
      </div>
